...
import com.hms.utsmobileprogramming.adapter.MyCartAdapter;
...
public class CartActivity extends AppCompatActivity implements ICartLoadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        loadCartFromFirebase();
        ImageView buttonMoney = findViewById(R.id.btnMoney);

        buttonMoney.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CartActivity.this, MoneyActivity.class);
