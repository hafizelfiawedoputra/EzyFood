...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.MyCartViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyCartViewHolder holder, int position) {
        ...
        holder.txtPrice.setText(new StringBuffer("Rp. ").append(cartModelList.get(position).getPrice()));
        holder.txtName.setText(new StringBuffer().append(cartModelList.get(position).getName()));
        holder.txtQuantity.setText(new StringBuffer().append(cartModelList.get(position).getQuantity()));
